...
class TestQueryReport(IntegrationTestCase):
	...
	def test_xlsx_data_with_multiple_datatypes(self):
		...
		# Build the result
		xlsx_data, column_widths, _, _metadata = build_xlsx_data(data, visible_idx, include_indentation=0)
	...
	def test_xlsx_data_with_filters(self):
		...
		# Build the result
		xlsx_data, _column_widths, header_index, _metadata = build_xlsx_data(
	...
	def test_xlsx_export_with_composite_cell_value(self):
		...
		# Build the result
		xlsx_data, column_widths, header_index, _metadata = build_xlsx_data(data, visible_idx, include_indentation=0)
		# Export to excel
